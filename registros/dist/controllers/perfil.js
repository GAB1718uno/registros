...
exports.deleteUsuario = exports.actualizarUsuario = exports.crearPerfilCloudinary = exports.crearPerfil = exports.obtenerUsuario = exports.obtenerUsuarios = exports.revalidarToken = exports.comprobarLogin = void 0;
...
const crearPerfil = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const perfil = yield perfil_1.default.create(body);
